...
const Logo = ({
  ...
  const Vault = ({
    ...
    <path fill={fill} d="M35.36,40H15.73a5.17,5.17,0,0,1-5.16-5.17V15.19A5.17,5.17,0,0,1,15.73,10H35.36a5.17,5.17,0,0,1,5.16,5.17V34.81A5.17,5.17,0,0,1,35.36,40ZM15.73,11.59a3.6,3.6,0,0,0-3.6,3.6V34.81a3.6,3.6,0,0,0,3.6,3.6H35.36a3.6,3.6,0,0,0,3.6-3.6V15.19a3.6,3.6,0,0,0-3.6-3.6Z"/>
    <path fill={fill} d="M21.35,27.94l-4.57,4.37a.78.78,0,0,0,.54,1.34.8.8,0,0,0,.54-.21l4.58-4.38A5,5,0,0,1,21.35,27.94Z"/>
    <path fill={fill} d="M21.42,22a5,5,0,0,1,1.1-1.11l-4.31-4.31a.78.78,0,1,0-1.11,1.1Z"/>
    <path fill={fill} d="M34.34,16.59a.8.8,0,0,0-1.11,0l-4.57,4.38a5.22,5.22,0,0,1,1.08,1.12l4.57-4.37A.79.79,0,0,0,34.34,16.59Z"/>
    <path fill={fill} d="M29.67,28a5,5,0,0,1-1.1,1.11l4.31,4.31a.82.82,0,0,0,.56.23A.78.78,0,0,0,34,32.34Z"/>
    <path fill={fill} d="M25.55,30.76A5.76,5.76,0,1,1,31.3,25,5.77,5.77,0,0,1,25.55,30.76Zm0-10.27A4.51,4.51,0,1,0,30.05,25,4.51,4.51,0,0,0,25.55,20.49Z"/>
