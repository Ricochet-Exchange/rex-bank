...
contract("Bank", function(_accounts) {
  ...
  beforeEach(async function () {
    ...
    this.bank = await Bank.new(INTEREST_RATE, ORIGINATION_FEE, COLLATERALIZATION_RATIO, LIQUIDATION_PENALTY, this.ct.address, this.dt.address, this.userContract.address);
