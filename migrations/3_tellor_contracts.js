      ...
      await deployer.deploy(UserContract,TellorMaster.address).then(async function() {
        return deployer.deploy(CT, "10000000000000000000000").then(function() {
          return deployer.deploy(DT, "10000000000000000000000").then(function() {
            return deployer.deploy(Bank, 12, 1, 150, 25, "0xfe41cb708cd98c5b20423433309e55b53f79134a", 50, 1000000, 1000000, "0x5592EC0cfb4dbc12D3aB100b257153436a1f0FEa", 39, 1000000, 1000000, " 0x0D17ED8DDE4AF196ff638F3704e94A77419Df2b8")
          });
        });
      });
    })
